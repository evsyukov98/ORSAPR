...
namespace KompasGorka.API
{
    ...
    public class FigureBuilder
    {
        ...
        private void CreatePlatform()
        {
            ...
            iDocument2D.ksLineSeg(platformBeginning,
                platformBeginning,
                platformBeginning,
                _figureParams.PlatformThicknessT,
                1);
            ...
            iDocument2D.ksLineSeg(_figureParams.PlatformLengthF,
                _figureParams.PlatformThicknessT,
                _figureParams.PlatformLengthF,
                platformBeginning,
                1);
        ...
        private void CreateEndSlide(int thickness)
        {
            ...
            iDocument2D.ksLineSeg(
                ...
                _figureParams.PlatformHeightG,
                _figureParams.PlatformLengthF + _figureParams.StartLengthE +
                _figureParams.MainLengthL + _figureParams.EndLengthD,
                _figureParams.PlatformHeightG,
                1);
        ...
        private void CreatePillar(int thickness, int barriersHeight)
        {
            ...
            {
                iDocument2D.ksLineSeg(pillarBeginning,
                    -barriersHeight,
                    thickness,
                    -barriersHeight,
                    1);

                iDocument2D.ksLineSeg(thickness,
                    -barriersHeight,
                    thickness,
                    _figureParams.PlatformHeightG,
                    1);
            ...
            {
                iDocument2D.ksLineSeg(
                    pillarBeginning + _figureParams.PlatformLengthF,
                    -barriersHeight,
                    thickness + _figureParams.PlatformLengthF,
                    -barriersHeight,
                    1);

                iDocument2D.ksLineSeg(thickness + _figureParams.PlatformLengthF,
                    -barriersHeight,
                    thickness + _figureParams.PlatformLengthF,
                    _figureParams.PlatformHeightG,
                    1);
        ...
        private void CreateStairsBorder(int borderHeight)
        {
            ...
            {
                iDocument2D.ksLineSeg(borderBeginning,
                    borderBeginning + borderBetweenPlatform,
                    borderBeginning,
                    -borderHeight + borderBetweenPlatform,
                    1);

                iDocument2D.ksLineSeg(borderBeginning,
                    -borderHeight + borderBetweenPlatform,
                    -borderLength,
                    _figureParams.PlatformHeightG - borderHeight +
                    borderBetweenPlatform,
                    1);

                iDocument2D.ksLineSeg(-borderLength,
                    _figureParams.PlatformHeightG - borderHeight +
                    borderBetweenPlatform,
                    -borderLength,
                    _figureParams.PlatformHeightG + borderBetweenPlatform,
                    1);
        ...
        private void CreateStair(double x, double y)
        {
            ...
            iDocument2D.ksLineSeg(x - stairLength,
                y + stairHeight,
                x - stairLength,
                y,
                1);
        ...
        private void ExtrusionSketch(ksPart iPart, ksEntity iSketch,
            double depth, bool direction)
        {
            var iExtrusion =
                (ksEntity) iPart.NewEntity((short) Obj3dType.o3d_bossExtrusion);

            var extrusionDef =
                (ksBossExtrusionDefinition) iExtrusion.GetDefinition();
